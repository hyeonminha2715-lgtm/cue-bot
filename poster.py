...
def make_poster(background_path: str, title: str, output_path: str = "poster.png") -> str:
    ...
    draw.text((60, 960), "CUE", font=small_font, fill=(255, 255, 255, 255))
    draw.rectangle([60, 940, 130, 946], fill=ACCENT_COLOR)
    ...
    y = CANVAS_SIZE[1] - 200 - total_text_height
